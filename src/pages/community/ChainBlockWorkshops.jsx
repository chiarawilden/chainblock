...
export default function ChainBlockWorkshops() {
    const cards = [
    ...
    const pagelinks = [
        {id: 0, headerLink: "ChainBlock Workshops", url: "#header-1"},
    ...
    const pagebuttons = {
        ...
        nextPage: "/contribution-tutorial"
    }

    return (
        <div className="page">
            <div className="page-left">
                <h1 id="header-1">ChainBlock Workshops</h1>
