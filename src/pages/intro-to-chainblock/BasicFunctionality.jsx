...
export default function BasicFunctionality() {
    const cards = [
    ...
    const pagelinks = [
        {id: 0, headerLink: "Basic Functionality", url: "#header-1"},
    ...
    const pagebuttons = {
        previousPage: "/why-choose-chainblock",
    ...
    return (
        <div className="page">
            <div className="page-left">
                <h1 id="header-1">Basic Functionality</h1>
