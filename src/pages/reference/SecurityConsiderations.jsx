...
export default function SecurityConsiderations() {
    const cards = [
    ...
    const pagelinks = [
        {id: 0, headerLink: "Security Considerations", url: "#header-1"},
    ...
    const pagebuttons = {
        ...
        nextPage: "/style-guide"
    }

    return (
        <div className="page">
            <div className="page-left">
                <h1 id="header-1">Security Considerations</h1>
